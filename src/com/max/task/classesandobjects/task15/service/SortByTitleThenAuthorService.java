...
/**
 * The comparator that sort by title and then author.
 *
 * @author Maxim Semenko
 */
public class SortByTitleThenAuthorService implements Comparator<Book> {

    private final Comparator<Book> comparator;

    public SortByTitleThenAuthorService() {
        comparator = new SortByTitleService().thenComparing(new SortByAuthorService());
    }
